...
const styles = StyleSheet.create({
  ...
  budgetTitle: { fontSize: 19, fontWeight: '800', letterSpacing: -0.2 },
  statusPill: {
  ...
  amountRow: { fontSize: 28, fontWeight: '800', letterSpacing: -0.6, marginBottom: spacing.md },
  amountLimit: { fontSize: 15, fontWeight: '600' },
  progressMeta: { fontSize: 12, lineHeight: 17, marginTop: spacing.sm, marginBottom: spacing.md },
